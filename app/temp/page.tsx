...
export default function BlockchainCard() {
  ...
  useEffect(() => {
    const newBlocks: Block[] = Array.from({ length: 5 }, (_, i) => ({
      id: i,
      initialX: (Math.random() - 0.5) * 200, // Random X: -100 to 100
      initialY: (Math.random() - 0.5) * 200, // Random Y: -100 to 100
    }));
    setBlocks(newBlocks);
  }, []);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto relative">
      ...
      <motion.div
        ...
        transition={{ duration: 1, ease: 'easeOut', delay: 1.2 }} // Delay until blocks are in place
