...
function Navbar() {
  return (
    <div>
    <nav className="flex items-center justify-between flex-wrap font-[family-name:var(--font-geist-mono)]">
  
    <div className="text-sm lg:flex-grow ml-12 cursor-pointer">
      <a href="./Deposit" className="block mt-4 lg:inline-block lg:mt-0   mr-4">Deposit</a>
      <a href="#" className="block mt-4 lg:inline-block lg:mt-0 mr-4">Services</a>
      <a href="#" className="block mt-4 lg:inline-block lg:mt-0 ">About</a>
